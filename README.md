...
| `Spring AspectJ`    | One of the purposes - audit log recording in `@Async` mode                                                                                                                                                         |
| `Spring Web`        |                                                                                                                                                                                                                    |
| `Spring Validation` |                                                                                                                                                                                                                    |
| `Spring OAuth2`     | Resource server                                                                                                                                                                                                    |
| `Spring Kafka`      | Events are going through the Kafka as part of async processing, usually result is written to Redis                                                                                                                 |
| `Spring Tracing`    | `spanId` and `traceId` are used for all communication patterns (both async and sync) and logging                                                                                                                   |                                                                  
| `Liquibase`         |                                                                                                                                                                                                                    |
| `PostgreSQL`        |                                                                                                                                                                                                                    |
